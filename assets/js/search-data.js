    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/topo-tutorial/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Quyen_Vu_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%71%7A%76%35%30%30%36@%70%73%75.%65%64%75; %76%75%71%76.%70%68%79%73@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/vuqv", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/Quyen-Vu-2/", "_blank");
        },
      },{
        id: 'social-scholar',
